...
def train_unet(model: torch.nn.Module, 
    ...
    """
    Training function for the U-Net model for denoising diffusion probabilistic models (DDPM).

    Args:
        model (torch.nn.Module): The U-Net model.
        dataloader (DataLoader): Dataloader for training images.
        noise_scheduler: Noise scheduler for sampling and scaling noise.
    ...
    for epoch in range(epochs):
        ...
        for step, (images, _) in enumerate(progress_bar):
            ...
            # Compute the MSE loss between the predicted noise and actual noise
